...
export interface ReducerBuilder<InS extends OutS, OutS> {
  ...
  casesWithAction<P1>(
    actionCreators: [ActionCreator<P1>],
    handler: Handler<InS, OutS, FsaAction<P1>>
  ): ReducerBuilder<InS, OutS>;
  casesWithAction<P1, P2>(
    actionCreators: [ActionCreator<P1>, ActionCreator<P2>],
    handler: Handler<InS, OutS, FsaAction<P1 | P2>>
  ): ReducerBuilder<InS, OutS>;
  casesWithAction<P1, P2, P3>(
    actionCreators: [ActionCreator<P1>, ActionCreator<P2>, ActionCreator<P3>],
    handler: Handler<InS, OutS, FsaAction<P1 | P2 | P3>>
  ): ReducerBuilder<InS, OutS>;
  casesWithAction<P1, P2, P3, P4>(
    ...
    handler: Handler<InS, OutS, FsaAction<P1 | P2 | P3 | P4>>
  ): ReducerBuilder<InS, OutS>;
  casesWithAction<P>(
    actionCreators: Array<ActionCreator<P>>,
    handler: Handler<InS, OutS, FsaAction<P>>
